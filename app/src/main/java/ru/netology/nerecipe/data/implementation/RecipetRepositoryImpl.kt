package ru.netology.nerecipe.data.implementation
...
class RecipeRepositoryImpl(
    ...
    override fun addFavorite(recipeId: Long) = dao.addFavorite(recipeId)

    override fun delete(recipeId: Long) = dao.delete(recipeId)
