...
import ru.netology.nerecipe.data.implementation.RecipeRepositoryImpl
...
class RecipeViewModel(
    ...
    fun onSaveButtonClicked(author: String, title: String, category: String, content: List<Step>?) {
    ...
    fun onAddClicked() = recipeEditOrAddScreenEvent.call()
    ...
    fun filterSearch(charForSearch: CharSequence?): MutableList<Recipe> {
        ...
        if (charForSearch?.isBlank() == true) {
            when {
                recipes != null -> filterRecipes.addAll(recipes)
            }
        } else {
    ...
    override fun onEditClicked(recipe: Recipe) {
        currentRecipe.value = recipe
        recipeEditOrAddScreenEvent.value = recipe
    }

    override fun onRecipeClicked(recipe: Recipe) {
        currentRecipeScreenEvent.value = recipe
    }
