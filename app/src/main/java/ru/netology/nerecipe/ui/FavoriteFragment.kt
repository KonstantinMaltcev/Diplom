...
class FavoriteFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.recipeEditOrAddScreenEvent.observe(this) {
        ...
        viewModel.currentRecipeScreenEvent.observe(this) { currentRecipe ->
            val direction =
    ...
    override fun onCreateView(
        ...
        viewModel.data.observe(viewLifecycleOwner) { recipes ->
            ...
            when {
                favoriteRecipes.isEmpty() -> binding.emptyStateGroup.visibility = View.VISIBLE
